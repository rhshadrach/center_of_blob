...
from center_of_blob.widgets.boxed_range_slider import BoxedRangeSlider
from center_of_blob.widgets.panel import Panel
...
def create_set_origin_button(main_window: MainWindow) -> QPushButton:
    ...
    result.clicked.connect(lambda: main_window.click_set_origin())
    return result
...
def create_modify_centers(main_window: MainWindow) -> QPushButton:
    ...
    result.resize(150, 50)
    result.clicked.connect(lambda: main_window.click_modify_centers())
    return result
...
def create_draw_region(main_window: MainWindow) -> QPushButton:
    ...
    result.resize(150, 50)
    result.clicked.connect(lambda: main_window.click_draw_region())
    return result
...
def create_mouse_channel_checkboxes(
...
def create_panel(main_window: MainWindow) -> Panel:
    result = Panel(main_window)
    result.label.setMouseTracking(True)
    return result


def create_zoom_slider(main_window: MainWindow) -> QSlider:
...
__all__ = [
    ...
    "create_zoom_slider",
    "create_draw_region",
    "create_show_channels",
    "create_modify_centers",
    "create_center_size_slider",
    "create_centers_path_button",
    "create_show_center_checkboxes",
    "create_set_origin_button",
    "create_mouse_channel_checkboxes",
    "create_write_csv_button",
    "create_img_path_button",
]
